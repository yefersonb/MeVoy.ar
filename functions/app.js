...
// ─── Firebase Admin ───────────────────────────────────────────────────────────
// Local dev requires GOOGLE_APPLICATION_CREDENTIALS env var pointing to a
// service-account JSON file, OR FIREBASE_SERVICE_ACCOUNT set to an inline JSON
// string. Inside Cloud Functions, applicationDefault() picks up the runtime's
// own service account automatically — no key file needed there.
let adminDb = null;
try {
